...
export const MATERIALS_DATA = {
  warmTones: [
    { 
      name: 'Chrome', 
      hex: '#E5E7EB', 
      swatchImage: '/images/swatches/chrome.png',
    ...
    { 
      ...
      hex: '#B5B09C', 
      swatchImage: '/images/swatches/inox.png',
    ...
    { 
      ...
      hex: '#D1A751', 
      swatchImage: '/images/swatches/pvd_brushed_gold.png',
    ...
    { 
      ...
      hex: '#EAD5A7', 
      swatchImage: '/images/swatches/pvd_miele.png',
    ...
    { 
      name: 'PVD Gold', 
      hex: '#E5C544', 
      swatchImage: '/images/swatches/pvd_gold.png',
  ...
  timelessClassics: [
    { 
      name: 'Velvet Black', 
      hex: '#121212', 
      swatchImage: '/images/swatches/velvet_black.png',
    ...
    { 
      ...
      hex: '#A46E56', 
      swatchImage: '/images/swatches/red_canyon.png',
    ...
    { 
      name: 'Soft Bronze', 
      hex: '#786447', 
      swatchImage: '/images/swatches/soft_bronze.png',
    ...
    { 
      ...
      hex: '#D4D8DF', 
      swatchImage: '/images/swatches/brushed_stainless.png',
    ...
    { 
      name: 'Anthracite', 
      hex: '#4D5054', 
      swatchImage: '/images/swatches/anthracite.png',
  ...
  armourCollection: [
    { 
      name: 'Soft Burgundy', 
      hex: '#8C584E', 
      swatchImage: '/images/swatches/soft_burgundy.png',
